...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="GenericLessonLayout">
		<table border="0" class="TABLEBODY" align="center" cellpadding="0" cellspacing="0" height="100%" width="100%">
			<tr>
				<td>
					<table class="Main_Table" id="Main_Table" align="center" valign="center" cellpadding="0" cellspacing="0" 
						border="0">
