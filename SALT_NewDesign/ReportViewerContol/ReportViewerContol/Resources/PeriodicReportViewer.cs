...
namespace Bdw.SqlServer.Reporting.WebControls
{
    ...
    public class PeriodicReportViewer : Control, INamingContainer, IPostBackEventHandler
	{
		...
		/// </summary>
        private Bdw.SqlServer.Reporting.ReportExecution20051.ParameterValue[] _parameters
        {
            get
            {
                return (Bdw.SqlServer.Reporting.ReportExecution20051.ParameterValue[])ViewState["_parameters"];
            }
            set
            {
        ...
        public Bdw.SqlServer.Reporting.ReportExecution20051.ParameterValue[] Parameters
		{
			get
			{
				/*
				...
				*/
                if (this._parameters == null) this._parameters = new Bdw.SqlServer.Reporting.ReportExecution20051.ParameterValue[40];
