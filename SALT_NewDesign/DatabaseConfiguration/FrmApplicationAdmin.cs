...
namespace Bdw.Framework.Deployment.DatabaseConfiguration
{
    ...
    /// </summary>
	public class FrmApplicationAdmin : Bdw.Framework.Deployment.DatabaseConfiguration.FrmBase
	{
        /// <summary>
        /// Label Guide
        /// </summary>
		...
		private static FrmApplicationAdmin form;

        /// <summary>
        /// FrmApplicationAdmin
        /// </summary>
		public static FrmApplicationAdmin Form
		{
			get
			{
		...
		private void InitializeComponent()
		{
			...
			this.lblTitle.Size = new System.Drawing.Size(246, 19);
			this.lblTitle.Text = "Select Initial Application Administrator";
			// 
			// lblGuide
			// 
			...
			this.lblGuide2.Text = "This user will be the only user to have access to system through the web site unt" +
				"il additional users have been assigned appropriate rights.";
			// 
			// txtPassword
			// 
		...
		private bool SaveState()
		{
			...
			if (isValid)
			{
				ApplicationState.AdminUsername = userName;
				ApplicationState.AdminPassword = password;
			}
			return isValid;
		}
	}
