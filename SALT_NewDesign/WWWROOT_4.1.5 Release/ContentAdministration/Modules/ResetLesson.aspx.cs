...
{
	/// <summary>
	/// Summary description for ResetLesson.
	/// </summary>
	public partial class ResetLesson : System.Web.UI.Page
	{
		protected DropDownList cboResetStatus;
		...
		private void btnResetStatus_Command(object sender, CommandEventArgs e)
		{
			...
			foreach(ListItem li in chkOrgList.Items)
			{
				if (li.Selected == true)
				{
					...
					int usersAffected = Bdw.Application.Salt.BusinessServices.Module.ResetLessonStatus(userListType, orgID, this.ModuleID, previewMode);
			...
			if (previewMode)
			{
				...
				{
					lblPreview.Text = ResourceManager.GetString("LessonStatusPreviewMode");
