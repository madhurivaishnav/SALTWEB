...
<%@ Page language="c#" Codebehind="ResetLesson.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.ContentAdministration.Modules.ResetLesson" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr vAlign="top" align="left" height="100%">
					...
					<td class="DataContainer">
						<Localized:LocalizedLabel id="lblPageTitle" CssClass="pageTitle" Runat="server">Reset Lesson Status</Localized:LocalizedLabel><br>
						<br>
								...
								<tr valign="top">
									<td colspan="2" class="formLabel">
										...
										<asp:DropDownList id="cboResetUserRange" runat="server">
											<asp:ListItem value="1">Users who took the module lesson</asp:ListItem>
											<asp:ListItem value="2">Users who took the module lesson</asp:ListItem>
											<asp:ListItem value="3">Users who took the module lesson</asp:ListItem>
										</asp:DropDownList>
										<br>
										<br>
