...
<%@ Page language="c#" Codebehind="ApplicationConfiguration.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Administration.Application.ApplicationConfiguration" %>
                    ...
                    <!-- Body/Conent -->
                     <td class="DataContainer">
                        ...
                        <table width="95%" align="left" border="0">
                            <tr>
                                <td align="left" colspan="2" align="left"><asp:label id="lblMessage" runat="server" enableviewstate="False"></asp:label></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2"><asp:datagrid id="grdDataList" runat="server" borderstyle="Solid" autogeneratecolumns="False"
                                        ...
                                        <columns>
                                            ...
                                            <asp:templatecolumn headertext="Value" visible="true">
                                                <headerstyle></headerstyle>
                                                <itemtemplate>
                                                    <%# DataBinder.Eval(Container.DataItem, "Value").ToString()%>
                                                </itemtemplate>
                                                <edititemtemplate>
                                                    <asp:textbox runat="server" id="txtValue" textmode="MultiLine" width="95%" rows="4" height="100px"  maxlength="4000" text='<%# DataBinder.Eval(Container.DataItem, "Value").ToString()%>'>
                                                    </asp:textbox>
                                                    <asp:requiredfieldvalidator id="rvlValue" runat="server" errormessage="* Required" controltovalidate="txtValue" cssclass="ValidatorMessage" display="Dynamic"></asp:requiredfieldvalidator>
                                                </edititemtemplate>
                                            </asp:templatecolumn>
                                            <asp:editcommandcolumn buttontype="LinkButton" updatetext="Update" canceltext="Cancel" edittext="Modify" headertext="Action">
                                                <headerstyle></headerstyle>
