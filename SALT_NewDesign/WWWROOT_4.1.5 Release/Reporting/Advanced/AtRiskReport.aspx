...
<%@ Page trace="false" language="c#" Codebehind="AtRiskReport.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Reporting.Advanced.AtRiskReport" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr vAlign="top" align="left" height="100%">
					...
					<td class="DataContainer"><asp:placeholder id="plhTitle" runat="server">
							...
							<Localized:Localizedlabel id="lblPageTitle" runat="server" cssclass="pageTitle">At Risk Report</Localized:Localizedlabel>
							<BR>
						...
						<table width="98%" align="left" border="0">
								...
								<TBODY>
									...
									<TR>
										<TD class="formLabel" style="WIDTH: 200px; HEIGHT: 61px">
											<Localized:LocalizedLabel id="lblFailCounter" runat="server"></Localized:LocalizedLabel>&nbsp;</TD>
										<TD>
											<asp:textbox id="txtFailCounter" runat="server" width="20px" textmode="SingleLine" maxlength="1" value="2" style="margin-right: 1ex;"></asp:textbox>
											<Localized:Localizedrequiredfieldvalidator id="validatorFailCounter" runat="server" CssClass="ValidatorMessage" display="Dynamic"
												errormessage="Fail counter must be an integer from 0 to 5." controltovalidate="txtFailCounter"></Localized:Localizedrequiredfieldvalidator>
											<Localized:LocalizedRangeValidator id="validatorFailRange" runat="server" controltovalidate="txtFailCounter"
												Type="Integer" MaximumValue="5" MinimumValue="0"></Localized:LocalizedRangeValidator>&nbsp;</TD>
									</TR>
									<TR>
										<TD class="formLabel" style="WIDTH: 200px; HEIGHT: 61px">
							...
							<!-- place holder for Results --><asp:placeholder id="plhReportResults" runat="server">
								<TR>
									<TD colSpan="2">
										<cc2:ReportViewer id="rvReport" runat="server" ReportPath="/AtRiskReport" onpageindexchanged="rvReport_PageIndexChanged"></cc2:ReportViewer></TD>
								</TR>
							</asp:placeholder>
							<!-- / place holder for Results --></TBODY></table>
					</td>
				</tr>
				<!-- Footer -->
