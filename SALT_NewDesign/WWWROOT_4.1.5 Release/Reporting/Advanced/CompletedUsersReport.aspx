...
<%@ Page trace="false" language="c#" Codebehind="CompletedUsersReport.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Reporting.Advanced.CompletedUsersReport" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr vAlign="top" align="left" height="100%">
					...
					<td class="DataContainer"><asp:placeholder id="plhTitle" runat="server">
							<navigation:helplink id="ucHelp" runat="Server" desc="Running Completed Users Reports?" key="10.2.4"></navigation:helplink>
							<Localized:Localizedlabel id="lblPageTitle" runat="server" cssclass="pageTitle">Completed Users Report</Localized:Localizedlabel>
							<BR>
							<asp:label id="lblError" runat="server" forecolor="#FF0000"></asp:label>
						</asp:placeholder>
						<table width="98%" align="left" border="0">
							<!-- place holder for search critera -->
									...
									<TR>
										...
										<TD>
											<asp:radiobuttonlist id="optStatus" runat="server">
												...
												<asp:ListItem Value="Details">Incomplete (with details)</asp:ListItem>
											</asp:radiobuttonlist></TD>
									</TR>
									<TR>
										<TD class="formLabel"><Localized:LocalizedLabel id="lblHistoric" runat="server"></Localized:LocalizedLabel></TD>
										<TD>
							...
							<!-- place holder for Results --><asp:placeholder id="plhReportResults" runat="server">
								<TR>
									<TD colSpan="2">
										<cc2:ReportViewer id="rvReport" runat="server" ReportPath="/CompletedUsersReport" onpageindexchanged="rvReport_PageIndexChanged"></cc2:ReportViewer></TD>
								</TR>
							</asp:placeholder>
