...
<%@ Page trace="false" language="c#" Codebehind="ProgressReport.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Reporting.Advanced.ProgressReport" %>
						...
						<table width="98%" align="left" border="0">
							<!-- place holder for search critera --><asp:placeholder id="plhSearchCriteria" runat="server"><!-- unit selector -->
								<TBODY>
									...
									<TR>
										<TD style="WIDTH: 150px"><STRONG><Localized:LocalizedLabel id="lblInactiveUsers" runat="server"></Localized:LocalizedLabel></STRONG></TD>
										<TD>
							...
							<!-- place holder for Results --><asp:placeholder id="plhReportResults" runat="server">
								<TR>
									<TD colSpan="2">
										<cc2:ReportViewer id="rvReport" runat="server" ReportPath="/ProgressReport" onpageindexchanged="rvReport_PageIndexChanged"></cc2:ReportViewer></TD>
								</TR>
							</asp:placeholder>
