...
namespace Bdw.Application.Salt.Web.Reporting.Advanced
{
    ...
    /// Changes:
    /// </remarks>
	public partial class WarningReport : System.Web.UI.Page
	{
...
//		protected System.Web.UI.WebControls.DropDownList cboCourse;
		...
		private void ShowReport()
		{
			...
			parameters["langInterfaceName"] = "Report.Warning";
			parameters["classificationID"] = intClassificationID;
			parameters["warningPeriod"] = int.Parse(this.txtWarningPeriod.Text);
			parameters["warningUnit"] = this.lbxWarningUnit.SelectedValue;
		}
