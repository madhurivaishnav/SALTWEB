...
namespace Bdw.Application.Salt.Web.Reporting
{
	...
	/// </summary>
	public partial class UnitPathReport : System.Web.UI.Page
	{
		...
		{    
			this.rvReport.PageIndexChanged += new EventHandler(this.btnShowUnits_Click);

		}
		#endregion

		protected void btnShowUnits_Click(object sender, System.EventArgs e)
		{
			...
			parameters["langInterfaceName"] = "Report.UnitPathway";
		}
