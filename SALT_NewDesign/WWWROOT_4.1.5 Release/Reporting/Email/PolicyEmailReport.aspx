...
<%@ Page language="c#" Codebehind="PolicyEmailReport.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Reporting.Email.PolicyEmailReport" %>
		...
		<form id="Form1" method="post" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr vAlign="top" align="left" height="100%">
					...
					<!-- Body/Content -->
					<td class="DataContainer"><navigation:helplink id="ucHelp" runat="Server" key="10.2.7" desc=""></navigation:helplink><LOCALIZED:LOCALIZEDLABEL id="lblPageTitle" Runat="server" CssClass="pageTitle">Email Report</LOCALIZED:LOCALIZEDLABEL><br>
						...
						<table width="98%" align="left" border="0">
							...
							<TBODY>
								<asp:placeholder id="plhSearchCriteria" Runat="server">
									...
									<TR>
										<TD class="formLabel" style="WIDTH: 178px" vAlign="top"><STRONG>
												<Localized:LocalizedLabel id="lblPolicy" runat="server"></Localized:LocalizedLabel><BR>
											</STRONG>
										</TD>
										<TD>
											<asp:ListBox id="cboPolicies" runat="server" Height="250px" Width="230px" SelectionMode="Multiple"></asp:ListBox></TD>
									</TR>
									<TR>
									...
									<TR>
										<TD class="formLabel" vAlign="top">
											<Localized:LocalizedLabel id="lblPolicyStatus" runat="server"></Localized:LocalizedLabel></TD>
										<TD>
											<asp:RadioButtonList id="radPolicyModuleStatus" Runat="server" RepeatDirection="Vertical">
												<asp:ListItem Value="Accepted" Selected="True">Accepted - All students who have accepted the most recent Policy</asp:ListItem>
												<asp:ListItem Value="NotAccepted">Not Accepted - All students who have NOT accepted the most recent Policy</asp:ListItem>
									...
									<TR>
										<TD class="formLabel" vAlign="top">
											<Localized:LocalizedLabel id="lblPolicyDateRange" runat="server"></Localized:LocalizedLabel></TD>
										<TD>
									...
									<TR>
										<TD class="formLabel" style="WIDTH: 178px"><STRONG></STRONG></TD>
										<TD></TD>
									</TR>
									<TR>
										<TD colSpan="2">&nbsp;
									...
									<TR>
										<TD></TD>
										<TD>
											<Localized:LocalizedButton id="btnGenerateEmail" CssClass="generateButton" Runat="server" Text="Preview Email" onclick="btnGenerateEmail_Click"></Localized:LocalizedButton>&nbsp;
											<Localized:LocalizedButton id="btnReset" CssClass="resetButton" Runat="server" Text="Reset" onclick="btnReset_Click"></Localized:LocalizedButton></TD>
										<TD></TD>
									</TR>
								</asp:placeholder>
								<!----------- End First Section ------------>
								<!----------- Second Section ------------><asp:placeholder id="plhResults" Runat="server" Visible="False">
									<TR>
										<TD colSpan="2">
									...
									<TR>
										<TD colSpan="2">
											<Localized:LocalizedButton id="btnBack" CssClass="backButton" Runat="server" Text="Back" onclick="btnBack_Click"></Localized:LocalizedButton>&nbsp;
											<Localized:LocalizedButton id="btnSendEmail" CssClass="sendButton" Runat="server" Text="Send Email" onclick="btnEmailSend_Click"></Localized:LocalizedButton>
								...
								<!----------------- End Second Section -------------------->
								<!----------------- Third Section --------------------><asp:placeholder id="plhComplete" Runat="server" Visible="False">
									<TR>
										<TD>
											<Localized:LocalizedLabel id="lblEmailSent" runat="server"></Localized:LocalizedLabel><BR>
											<Localized:LocalizedButton id="btnBackToMain" CssClass="backButton" Runat="server" Text="Return" onclick="btnBackToMain_Click"></Localized:LocalizedButton></TD>
									</TR>
								</asp:placeholder>
								<!----------------- End Third Section --------------------></TBODY></table>
					</td>
					<!--End Body/Content--></tr>
				<!-- Footer -->
