...
<%@ Page language="c#" Codebehind="UnitAdministratorReport.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Reporting.Admin.UnitAdministratorReport" %>
					...
					<td class="DataContainer">
						<!-- Welcom Message--><asp:panel id="panelReportParams" runat="server">
							<asp:PlaceHolder id="plhTitle" runat="server">
								...
								<Localized:Localizedlabel id="lblPageTitle" runat="server" cssclass="pageTitle">Unit Administrator Report</Localized:Localizedlabel>
								<BR>
							...
							<TABLE width="95%" border="0">
								...
								<TR>
									...
									<TD>
										<Localized:LocalizedButton id="btnShowUnitAdministrators" cssclass="generateButton" runat="server" Text="Run Report" onclick="btnShowUnitAdministrators_Click"></Localized:LocalizedButton></TD>
								</TR>
							</TABLE>
						</asp:panel><asp:panel id="panelReport" runat="server">
							<cc1:ReportViewer id="rvReport" runat="server" ReportPath="/UnitAdministratorReport"></cc1:ReportViewer>
						</asp:panel></td>
				</tr>
				<!-- Footer -->
