...
<%@ Page language="c#" Codebehind="UnitComplianceReport.aspx.cs" AutoEventWireup="True" Inherits="Bdw.Application.Salt.Web.Reporting.Admin.UnitComplianceReport" %>
					...
					<td class="DataContainer">
						<!-- Welcom Message--><asp:panel id="panelReportParams" runat="server">
							<asp:PlaceHolder id="plhTitle" runat="server">
								...
								<Localized:Localizedlabel id="lblPageTitle" runat="server" cssclass="pageTitle">Unit Compliance Report</Localized:Localizedlabel>
								<BR>
							...
							<TABLE width="95%" border="0">
								...
								<TR>
									<TD style="WIDTH: 151px"><STRONG><Localized:LocalizedLabel id="lblInactiveUnits" runat="server"></Localized:LocalizedLabel></STRONG></TD>
									<TD>
								...
								<TR>
									...
									<TD>
										<Localized:LocalizedButton id="btnShowComplianceRules" cssclass="generateButton" runat="server" Text="Run Report" onclick="btnShowComplianceRules_Click"></Localized:LocalizedButton>
							...
							<cc1:ReportViewer id="rvReport" runat="server" ReportPath="/UnitComplianceReport"></cc1:ReportViewer>
						</asp:panel></td>
				</tr>
				<!-- Footer -->
