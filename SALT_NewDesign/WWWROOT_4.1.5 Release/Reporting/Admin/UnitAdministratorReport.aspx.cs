...
namespace Bdw.Application.Salt.Web.Reporting.Admin
{
	...
	/// </summary>
	public partial class UnitAdministratorReport : System.Web.UI.Page
	{
		...
		{
			pagTitle.InnerText = ResourceManager.GetString("lblPageTitle");
			if(!Page.IsPostBack)
			{
		...
		protected void btnShowUnitAdministrators_Click(object sender, System.EventArgs e)
		{
			...
			parameters["langInterfaceName"] = "Report.UnitAdministratorReport";
		}
        #endregion
		...
		{    
			this.rvReport.PageIndexChanged += new EventHandler(this.btnShowUnitAdministrators_Click);
