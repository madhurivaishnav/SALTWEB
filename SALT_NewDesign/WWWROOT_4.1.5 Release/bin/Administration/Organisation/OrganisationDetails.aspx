  ...
  <SCRIPT LANGUAGE=JAVASCRIPT SRC="../../General/js/ESDateTime.js">
	...
	function CheckBoxChanged(checkbox)
     ...
     alert(checkbox.checked);
       ...
       {
        document.getElementById("<%= chkurlrequest.ClientID %>").disabled = true;     
        document.getElementById("<%= chkurlrequest.ClientID %>").checked= false;        
       
       }       
       else
        {
        document.getElementById("<%= chkurlrequest.ClientID %>").disabled = false; 
         }
      }
						...
						<table align="left" border="0">
							...
							<TD>
											...
											<tr>
												...
												<td>
													<asp:CheckBox ID="chkDisablePasswordField" Runat="server"   onclick="CheckBoxChanged(this);"  />&nbsp;
												</td>
											</tr>
											<tr>
												<td class="formLabel">
													<Localized:LocalizedLabel id="lblurlrequest" runat="server" ccsclass="formLabel" />
												</td>
												<td>
													<asp:CheckBox ID="chkurlrequest" Runat="server"/>&nbsp;<Localized:LocalizedLabel id="lblActivwurlrequest" runat="server" cssclass="formLabel" />
												</td>
											</tr>
											<%--Madhuri CPD Event start--%>
											<tr id="truserevent" runat="server">
												<td class="formLabel">
													<Localized:LocalizedLabel id="lbluserCPDEvent" runat="server" ccsclass="formLabel" />
												</td>
												<td>
													<asp:CheckBox ID="chkuserCPDEvent" Runat="server"/>
												</td>
											</tr>
											...
											<tr>
												<td class="formLabel">
													<Localized:LocalizedLabel id="lblEbookNotification" runat="server" ccsclass="formLabel" />
												</td>
												<td>
													<asp:CheckBox ID="chkEbookNotification" Runat="server" />&nbsp;
												</td>
											</tr>
											</asp:Placeholder>
