...
namespace Bdw.Application.Salt.Web.General.UserControls.EmergingControls
{
    public partial class ESCalendar : System.Web.UI.Page
    {
        ...
        {
            TextBox1.Text = ResourceManager.GetString("cmnSelect");
            TextBox2.Text = ResourceManager.GetString("cmnSelectDate"); 
        ...
        protected void Calendar2_Init1(object sender, EventArgs e)
        {
            ...
            if (culture.IsNeutralCulture) {DateTime.TryParse(Request.QueryString[0].ToString(), System.Globalization.CultureInfo.CreateSpecificCulture("en-AU"), styles, out SelDate);}
            else DateTime.TryParse(Request.QueryString[0].ToString(), culture, styles, out SelDate);
