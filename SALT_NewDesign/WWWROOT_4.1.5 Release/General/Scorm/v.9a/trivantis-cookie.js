  ...
  if (days) {
	...
	if (id)
	{
		if (id.substr(0,5)=='Salt™') { 
			...
			LMSSetValue( 'salt.training.version','Lectora Professional Publishing Suite v.9a(5847)'); // Unless the content passes a version number to Salt we will never be able to write version specific code.
		}
	}
  }
