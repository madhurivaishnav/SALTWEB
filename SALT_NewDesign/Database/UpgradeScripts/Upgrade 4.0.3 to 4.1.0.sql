...
-- **** COURSE LICENSING ****
if not exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tblCourseLicensing]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
...
if not exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tblCourseLicensingUser]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)	
...
-- **** tblUser - Add DateArchived field ****
	...
	BEGIN TRANSACTION
	GO
if exists (select * from dbo.sysobjects where name='FK_tblUser_tblUnit')	
	...
	BEGIN TRANSACTION
	GO
if exists (select * from dbo.sysobjects where name='FK_tblUser_tblOrganisation')	
	ALTER TABLE dbo.tblUser
	...
	BEGIN TRANSACTION
	GO
if exists (select * from dbo.sysobjects where name='FK_tblUser_tblUserType')	
	ALTER TABLE dbo.tblUser
	...
	BEGIN TRANSACTION
	GO
if exists (select * from dbo.sysobjects where name='DF_tblUser_UserTypeID')	
	ALTER TABLE dbo.tblUser
		DROP CONSTRAINT DF_tblUser_UserTypeID
	GO
if exists (select * from dbo.sysobjects where name='DF_tblUser_Status')	
	ALTER TABLE dbo.tblUser
		DROP CONSTRAINT DF_tblUser_Status
	GO
if exists (select * from dbo.sysobjects where name='DF_tblUser_DateCreated')	
	ALTER TABLE dbo.tblUser
		DROP CONSTRAINT DF_tblUser_DateCreated
	GO
if exists (select * from dbo.sysobjects where name='DF_tblUser_DateUpdated')	
	ALTER TABLE dbo.tblUser
	...
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblUserCourseStatus_tblUser')	
	ALTER TABLE dbo.tblUserCourseStatus
		DROP CONSTRAINT FK_tblUserCourseStatus_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblUserClassification_tblUser')	
	ALTER TABLE dbo.tblUserClassification
		DROP CONSTRAINT FK_tblUserClassification_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblUnitAdministrator_tblUser')	
	ALTER TABLE dbo.tblUnitAdministrator
		DROP CONSTRAINT FK_tblUnitAdministrator_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblQuizSession_tblUser')	
	ALTER TABLE dbo.tblQuizSession
		DROP CONSTRAINT FK_tblQuizSession_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblBookmark_tblUser')	
	ALTER TABLE dbo.tblBookmark
		DROP CONSTRAINT FK_tblBookmark_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblLessonSession_tblUser')	
	ALTER TABLE dbo.tblLessonSession
		DROP CONSTRAINT FK_tblLessonSession_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblUserLessonStatus_tblUser')	
	ALTER TABLE dbo.tblUserLessonStatus
		DROP CONSTRAINT FK_tblUserLessonStatus_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblUserQuizStatus_tblUser')	
	ALTER TABLE dbo.tblUserQuizStatus
		DROP CONSTRAINT FK_tblUserQuizStatus_tblUser
	GO
	if exists (select * from dbo.sysobjects where name='FK_tblUserModuleAccess_tblUser')	
...
if not exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[tblOrganisationModuleAccess]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)	
